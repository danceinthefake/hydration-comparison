<script lang="ts">
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: 'We chose SvelteKit for our marketing site and have never looked back. Minimal JS means minimal problems!',
      avatar: 'AT'
    }
  ];
...
<section id="testimonials" class="testimonials-section">
  ...
  <div class="carousel">
    <button class="nav-btn prev" on:click={prev} aria-label="Previous testimonial">
      &lt;
    </button>
    ...
    <button class="nav-btn next" on:click={next} aria-label="Next testimonial">
      &gt;
    </button>
  </div>
  <div class="dots">
