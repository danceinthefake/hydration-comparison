<script lang="ts">
  const faqs = [
    ...
    },
    {
      ...
      answer: 'SvelteKit with adapter-static ships the smallest JS runtime among full-stack frameworks. Astro goes further with zero-JS by default. Next.js and Nuxt require larger framework runtimes even for static content.'
    }
  ];
    ...
    {#each faqs as faq, index}
      <div class="faq-item">
        ...
        >
          ...
          <span class="icon" class:open={openIndex === index}>+</span>
        </button>
